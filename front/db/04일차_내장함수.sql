...
# LPAD(문자열, 자리, '채울 문자열') : 문자열이 자리수보다 작으면 왼쪽에 채울 문자열을 추가하여 자리수를 맞춤
# RPAD(문자열, 자리, '채울 문자열') : 문자열이 자리수보다 작으면 오른쪽에 채울 문자열을 추가하여 자리수를 맞춤

# RGB(255,20,30)을 16진수로 변경해서 #FF1403으로 표현하는 쿼리
SELECT CONCAT('#', LPAD(HEX(255),2,'0'), LPAD(HEX(20),2,'0'), LPAD(HEX(3),2,'0')) 'RGB(255,20,30)';
