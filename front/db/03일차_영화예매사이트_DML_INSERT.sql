...
insert INTO movie
	values(null,'데드풀과 울버린', '히어로 생활에서 은퇴한 후,
							평범한 중고차 딜러로 살아가던 ‘데드풀’이
							예상치 못한 거대한 위기를 맞아
							모든 면에서 상극인 ‘울버린’을 찾아가게 되며 펼쳐지는
							도파민 폭발 액션 블록버스터',
			127, '청소년 관람 불가', '2024.07.24');
# 2. 국가를 등록. 한국, 미국, 영국, 일본, 중국
insert INTO country
	values('한국'), ('미국'), ('영국'), ('일본'), ('중국');

# 3. 영화 참여 국가를 추가 : 데드풀과 울버린 영화의 참여 국가
INSERT INTO movie_country(MC_NUM, MC_CO_NAME, MC_MO_NUM) value (null, '미국', 1);
# 4. 장르를 추가. 액션, 코미디, 멜로, 공포, 스릴러
INSERT INTO genre VALUES ('액션'), ('코미디'), ('멜로'), ('공포'), ('스릴러');
# 5. 영화 장르를 추가 : 데드풀과 울버린의 장르
INSERT INTO movie_genre(MG_NUM, MG_GE_NAME, MG_MO_NUM) VALUES (null, '액션', 1), (null, '코미디', 1);
# 6. 영화인을 등록 : 데드풀과 울버린의 나오는 모든 영화인
INSERT INTO PERSON(PS_NUM, PS_NAME, PS_BIRTH, PS_DETAIL, PS_COUNTRY)
	values
    (null, '숀 레비', '1968.07.23', '', '캐나다'),
    (null, '라이언 레이놀즈', '1976.10.23', '<엑스맨 탄생: 울버린> 등의 액션 블...', '캐나다'),
    (null, '휴 잭맨', '1968.10.12', '호주 출신 배우인 휴 잭맨은 ...', ''),
...
INSERT INTO theater VALUES(NULL, 'CGV 강남', 3, 30, '서울특별시 강남구 강남대로 438 스타플렉스 4층~8층', '서울');
INSERT INTO screen VALUES(NULL, '1관', 10, 1), (NULL, '2관', 10, 1), (NULL, '3관', 10, 1);
...
# 4관 : A1~A6, B1~B6
INSERT INTO theater VALUES(NULL, 'CGV 영등포', 4, 44, '서울특별시 영등포구 영중로 15 타임스퀘어 4F', '서울');
...
(NULL, "09:00", '2024.7.27', 1, 1, 3), (NULL, "11:35", '2024.7.27', 0, 1, 3),
(NULL, "14:10", '2024.7.27', 0, 1, 3), (NULL, "16:45", '2024.7.27', 0, 1, 3),
(NULL, "19:20", '2024.7.27', 0, 1, 3),
(NULL, "10:00", '2024.7.27', 1, 1, 1), (NULL, "12:35", '2024.7.27', 0, 1, 1),
(NULL, "15:10", '2024.7.27', 0, 1, 1), (NULL, "17:45", '2024.7.27', 0, 1, 1),
(NULL, "20:20", '2024.7.27', 0, 1, 1),
(NULL, "10:30", '2024.7.27', 1, 1, 2), (NULL, "15:00", '2024.7.27', 0, 1, 2),
(NULL, "20:00", '2024.7.27', 0, 1, 2), (NULL, "23:00", '2024.7.27', 0, 1, 2);
...
# 3관 - 08:40(조조), 17:00
INSERT INTO SCHEDULE VALUES
(NULL, "08:00", '7/27', 1, 1, 4), (NULL, "10:40", '7/27', 0, 1, 4),
(NULL, "16:00", '7/27', 0, 1, 4), (NULL, "18:40", '7/27', 0, 1, 4),
(NULL, "09:40", '7/27', 1, 1, 5), (NULL, "15:00", '7/27', 0, 1, 5),
(NULL, "23:00", '7/27', 0, 1, 5),
(NULL, "08:40", '7/27', 1, 1, 6), (NULL, "17:00", '7/27', 0, 1, 6);