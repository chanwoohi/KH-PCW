...
public class StringEx01 {
	public static void main(String[] args) {
		...
		// char chaAt(index) : 문자열의 index 번지 문자를 반환
		System.out.println( str + "  3번째 문자 : " +str.charAt(2) );
		...
		//boolean contains(문자열) : 문자열이 잇는지 없는지 반환
		...
		//String substring(시작번지) : 시작번지 부터 부분 문자열을 추출
		//String substring(시작번지, 끝번지) : 시작번지 부터 끝번지 전까지 부분 문자열을 추출 (끝 번지 포함X)
