...
public class ListEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * remove(번지) : 리스트에서 번지 위치에 있는 객체를 삭제하고 삭제된 객체를 반환. 리스트 인터페이스에서 제공
		 * */
		...
		/* indexOf (객체) : 리스트에 객체가 몇 번지에 있는지 알려줌. 리스트 인터페이스 */
		
		System.out.println("리스트에 Hi가 몇 번지에 있습니까? " + list.indexOf("HI"));
		System.out.println("리스트에 홍길동이 몇 번지에 있습니까? " + list.indexOf("홍길동"));
